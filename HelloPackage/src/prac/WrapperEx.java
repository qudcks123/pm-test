...
public class WrapperEx {
	...
	public static void main(String[] args) {
		...
		if(Character.isDigit(c1)) {
			System.out.println(c1 + "는 숫자"); // 문자 C1이 숫자면 참
		}
		
		if(Character.isAlphabetic(c2)) {
			System.out.println(c2 + "는 영문자"); // 문자 C2가 영문자면 트루
		}
		...
		System.out.println(Integer.bitCount(28)); // 28에 대한 2진수으 1의 개수
		...
		boolean b = (4 > 3); // b는 참
		System.out.println(Boolean.toString(b)); // 참을 문자열 "true"러 변환
